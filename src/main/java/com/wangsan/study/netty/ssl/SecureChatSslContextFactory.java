...
public final class SecureChatSslContextFactory {
    ...
    private static String CLIENT_KEY_STORE = "D:\\tools\\keytool\\store\\cChat.jks";
    private static String CLIENT_TRUST_KEY_STORE = "D:\\tools\\keytool\\store\\cChat.jks";
    private static String CLIENT_KEY_STORE_PASSWORD = "cNetty";
    private static String CLIENT_TRUST_KEY_STORE_PASSWORD = "cNetty";

    private static String SERVER_KEY_STORE = "D:\\tools\\keytool\\store\\sChat.jks";
    private static String SERVER_TRUST_KEY_STORE = "D:\\tools\\keytool\\store\\sChat.jks";
    private static String SERVER_KEY_STORE_PASSWORD = "sNetty";
    private static String SERVER_TRUST_KEY_STORE_PASSWORD = "sNetty";
